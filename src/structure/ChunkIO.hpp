...
// Generic IFF chunk layer: [magic u32 BE][size u32 LE][payload]. No format knowledge.
// One mechanism for walking, finding and emitting chunks, shared by every translator.
namespace wraith::structure::iff
{
